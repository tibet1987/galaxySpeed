...
fixPositionOfMass1 = 1; % sun moves pretty much not at all when the earth wobbles around her
r2_init = [149e9 0, 0]';
...
plotTwoBodySimResults(r1,r2,'size1',30,'size2',18,'plotTrail',1,...
                            ...
                            'exportToGif',1,'gifName','script02_simulate_earths_orbit.gif')
