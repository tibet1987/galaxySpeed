...
plotTwoBodySimResults(r1,r2,'size1',30,'size2',18,'plotTrail',1,...
                            'timeScale',T_sample*10000,'trailLength',10)
...
close all
G = 6.674e-11; % m^3/(kg s^2)
m1 = 1e15; % kg, mass of body 1 (Pluto equivalent)
m2 = m1;   % kg, mass of body 2
fixPositionOfMass1 = 0;
r2_init = [5e8 0, 0]';
r2dot_init = [0, sqrt(G*m1/r2_init(1)),0]'; % 0.55e3
r1_init = -r2_init;
...
F_G = G*m1*m2/((r2_init(1)-r1_init(1))/2)^2
